    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-evenly items-start md:m-3 min-h-screen">
        <div className="flex flex-col items-center justify-center align-center mx-auto">
          <div className="border border-stone-400/40  bg-indigo-400/50 z-0 rounded-2xl mt-1 shadow-2xl md:px-15">
            <div className=" flex justify-center items-center md:mt-5 p-2 pt-5 ">
              <input
            ...
            {weather ? (
              <div className="border text-white border-indigo-500/60 rounded-3xl m-3 flex flex-col md:mt-10 hover:bg-indigo-500/60 hover:text-white hover:px-2 hover:md:px-20 transition-all duration-600 shadow-2xl">
                ...
                <div className="md:p-3 flex justify-center items-center">
                  <iframe
                    className="m-10 w-50 h-50 hover:w-100 hover:h-100 tarnsition-all duration-500"
                    src={`https://www.google.com/maps?q=${weather?.lat},${weather?.lon}&z=1&t=k&output=embed`}
